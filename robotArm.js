...
// Proportions (tuned)
const BASE_H = 2.8, BASE_W = 5.5, BASE_D = 3.5;
const ARM_H  = 4.2, ARM_W  = 0.7, ARM_D  = 0.7;

const GRIP_H = 2.0, GRIP_W = 0.35, GRIP_D = 0.35;   // finger size
...
function buildColoredCube() {
    ...
    quad(1, 0, 3, 2, vec4(0.80, 0.80, 0.80, 1.0));
